...
public class RoomsView extends JPanel implements IRoomEvents {
    ...
    public RoomsView(ICardControls controls) {
        ...
        back.addActionListener(e -> controls.previousView());
        ...
        searchButton.addActionListener(e -> {
            SwingUtilities.invokeLater(() -> {
                try {
                    ...
                    LoggerUtil.INSTANCE.warning("Error sending request: " + ex.getMessage(), ex);
                    message.setText("Error sending request: " + ex.getMessage());
                }
            });
        });
        ...
        joinButton.addActionListener(e -> {
            SwingUtilities.invokeLater(() -> {
                try {
                    ...
                    LoggerUtil.INSTANCE.warning("Not connected", ex);
                    message.setText("Error sending request: " + ex.getMessage());
                }
            });
        });
